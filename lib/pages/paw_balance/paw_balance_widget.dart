...
import 'paw_balance_model.dart';
export 'paw_balance_model.dart';

class PawBalanceWidget extends StatefulWidget {
  const PawBalanceWidget({super.key});

  @override
  State<PawBalanceWidget> createState() => _PawBalanceWidgetState();
}

class _PawBalanceWidgetState extends State<PawBalanceWidget>
    with TickerProviderStateMixin {
  late PawBalanceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PawBalanceModel());
